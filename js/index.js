...
function updateTime() {
  function format(e) {if (e <= 9) {return '0' + e;}return e;}
  var time = document.getElementById('time');
  var hour = format(new Date().getHours());
  var minutes = format(new Date().getMinutes());
  var seconds = format(new Date().getSeconds());
